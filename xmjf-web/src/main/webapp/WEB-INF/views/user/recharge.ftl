...
<#include "../include/user_siderbar.ftl">
    <div class="content fr">
        ...
        <form id="fm" method="post" action="${ctx}/account/doAccountRechargeToRechargePage" >
        <div class="recharge-main">
            <div class="recharge-bankCard">
                <div class="third-pay">
                    ...
                    <p class="recharge_input_wrap"><input type="" name="amount" class="recharge-input" id="rechargeAmount"/></p>
                </div>
                <div class="third-pay">
                    <div class="third-pay-title">
                        验证码：
                ...
                <div class="third-pay">
                    ...
                    <input type="password" name="bussinessPassword" class="recharge-input" id="password"
                           style="margin-top: 18px;margin-left: 10px;float: left"/>
                </div>
                <div class="third-pay">
